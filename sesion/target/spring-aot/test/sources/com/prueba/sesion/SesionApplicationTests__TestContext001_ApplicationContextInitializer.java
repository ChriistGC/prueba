 ...
 */
public class SesionApplicationTests__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new SesionApplicationTests__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new SesionApplicationTests__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
